    ...
    public override IEnumerator SlowUpdate()
    {
        if (IsServer)
        {
            ...
            foreach (NPM n in players)
            {
                ...
                temp.GetComponent<PlayerCharacter>().ColorSelected = n.ColorSelected;
                temp.GetComponent<PlayerCharacter>().PName = n.PName;
                temp.GetComponentInChildren<Text>().text = n.PName;
                //temp.GetComponent<PlayerCharacter>().InitChar(n.PName + ";" + n.ColorSelected);                
                temp.GetComponent<PlayerCharacter>().SendUpdate("START", n.PName + ";" + n.ColorSelected);
            }
