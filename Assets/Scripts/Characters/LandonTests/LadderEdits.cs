...
public class LadderEdits : NetworkComponent
{
	public Dictionary<string, string> OTHER_FLAGS = new Dictionary<string, string>();
	public PlayerEdits attachedPlayer = null;
	...
	public void InitializeLadderVariables(PlayerEdits p){
		if (IsServer){
			PlayerEdits player = p;
